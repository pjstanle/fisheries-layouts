...
if __name__=="__main__":
    ...
    # optProb.addVar("shear",type="c",lower=-np.pi/2,upper=np.pi/2,value=shear)
    ...
    opt_xspacing = 10.0*rotor_diameter
    opt_yspacing = 5.291999999999996*rotor_diameter
    opt_rotation = np.deg2rad(-3.7821124525353995)
    opt_shear = np.deg2rad(-65.09662556182657)

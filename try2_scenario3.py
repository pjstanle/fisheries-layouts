...
def create_initial_grid(x_spacing,y_spacing,nturbs=53,ncols_left=1):
    global nrows
...
def evaluate_plant(x):
    ...
    base_x,base_y = create_initial_grid(x_spacing,y_spacing,nturbs=nturbs,ncols_left=ncols_left)
...
if __name__=="__main__":
    ...
    # x_spacing = 10
    x_spacing = 8.950446609632325
    y_spacing = 3.6213177578970877
    shear = np.deg2rad(63.93716447882448)
    rotation = np.deg2rad(-28.685587323041723)
    ...
    optimize.setOption("MAXIT",value=200)
